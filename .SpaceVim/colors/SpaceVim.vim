...
" License: GPLv3
"=============================================================================
" NOTE: (Saeid Saati Edition)
" this is so beautiful color:  ['Function'         , 39 , 17  , 'bold'      , 'bold']      ,
" the (30) for forground is also nice['Comment'          , 30  , s:bg5  , 'None'      , 'italic']    ,
...
let s:palette = {
      ...
      \ ['SpecialComment'   , 24  , s:bg1  , 'None'      , 'italic']      ,
